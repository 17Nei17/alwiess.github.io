...
var initAll = function (data) {
	...
	Kns.Png_cat_0 = function () {
		const cat_0 = document.getElementById('cat_0');
		Kns.dowloadPng(cat_0, 'cat_0')
	};
	Kns.Png_cat_1 = function () {
		const cat_1 = document.getElementById('cat_1');
		Kns.dowloadPng(cat_1, 'cat_1')
	};
	Kns.Png_cat__1 = function () {
		const cat__1 = document.getElementById('cat_-1');
		Kns.dowloadPng(cat__1, 'cat_-1')
	};
	Kns.Png_cat_5 = function () {
		const cat_5 = document.getElementById('cat_5');
		Kns.dowloadPng(cat_5, 'cat_5')
	};
	Kns.Png_cat_2 = function () {
		const cat_2 = document.getElementById('cat_2');
		Kns.dowloadPng(cat_2, 'cat_2')
	};

	Kns.dowloadPng = function (image, name) {
		const newimage = image.toDataURL('image/png');
		var link = document.createElement("a");
		newimage && link.setAttribute("href", newimage);
...
document.getElementById("stikers-panel").addEventListener('wheel', function (event) {
	console.log("asd")
